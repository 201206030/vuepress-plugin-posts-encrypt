...
export const IVIEW_CSS_TAG = `<link rel="stylesheet" type="text/css" href="/iview.css" />`
export const ANIMATECSS_TAG = `<link rel="stylesheet" href="/animate.min.css" />`
export const IVIEW_JS_TAG = `<script type="text/javascript" src="/iview.min.js"></script>`
